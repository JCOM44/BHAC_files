...
module mod_indices
   ...
   integer, parameter :: ngridshi  = 4096
...
!   integer, save :: itag, ierrmpi
   ...
   integer, dimension(:), allocatable, save :: recvrequest_stg,&
       sendrequest_stg
   integer, dimension(:,:), allocatable, save :: recvstatus_stg,&
       sendstatus_stg
   integer, save  :: type_coarse_block_stg(3,2,2,2), type_sub_block_stg(3,2,2,&
      2)
